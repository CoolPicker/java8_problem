...
public class CacheManager {
    ...
    public static void main(String[] args) {
        ...
        CacheManager.put(11111111l,"woai");
        CacheManager.put(22222222l,"luo");
        String s = CacheManager.get(11111111l);
        System.out.println(s);
        CacheManager.remove(11111111l);
        String s1 = CacheManager.get(11111111l);
